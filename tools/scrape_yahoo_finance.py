#!/usr/bin/env python3
"""
Yahoo Finance RSS Scraper
Scrapes latest financial news from Yahoo Finance RSS feed
"""
...
OUTPUT_FILE = ".tmp/raw_yahoo_finance.json"
...
def log_error(message):
    ...
    with open(ERROR_LOG, 'a') as f:
        f.write(f"[{timestamp}] [YahooFinance] {message}\n")
...
def main():
    ...
    print("=" * 60)
    print("Yahoo Finance RSS Scraper")
    print("=" * 60)
