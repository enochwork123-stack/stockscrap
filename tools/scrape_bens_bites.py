#!/usr/bin/env python3
"""
Ben's Bites RSS Scraper
Scrapes latest AI news articles from bensbites.com RSS feed
"""
...
RSS_URL = "https://bensbites.com/feed"
OUTPUT_FILE = ".tmp/raw_bens_bites.json"
...
def main():
    ...
    if save_articles(articles):
        print(f"✅ Successfully scraped {len(articles)} articles from Ben's Bites")
        sys.exit(0)
    else:
